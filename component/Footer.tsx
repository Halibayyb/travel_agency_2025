    ...
    return (
        <footer className="bg-[#52392F] text-white py-16 px-4">
            <div className="max-w-7xl mx-auto">
                {/* Header Section */}
                <div className="mb-12">
                    <h1 className="font1 text-2xl md:text-3xl font-light tracking-widest mb-4">
                        KHAMTRAVEL
                    </h1>
                ...
                <div className="hidden xl:grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    {/* Call Us */}
                    <div>
                        <h3 className="font1 text-sm font-medium mb-4 tracking-wide">
                            Call us
                        </h3>
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4">
                            <a 
                                href="#" 
                                className="w-12 h-12  bg-opacity-20 hover:bg-opacity-30 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110"
                                aria-label="Facebook"
                            >
                ...
                <div className="xl:hidden mb-12">
                    <h3 className="font1 text-sm font-medium mb-4 tracking-wide text-center">
                        Follow
                    </h3>
                ...
                <div className="border-t border-white pt-8">
                    <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        ...
                        <div className="flex flex-wrap justify-center md:justify-end space-x-6 text-sm">
                            <a 
                                href="#" 
                                className="font2 text-amber-100 hover:text-white transition-colors duration-300"
                            >
                                Privacy Policy
                            </a>
                            <a 
