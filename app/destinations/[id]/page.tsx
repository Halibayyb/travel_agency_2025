    ...
    <section className="min-h-screen bg-gradient-to-b from-amber-50 to-stone-100 pt-20">
      <div className="p-8">
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex justify-center flex-wrap gap-4 md:gap-8 mb-5">
            {tabs.map((tab) => {
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 gap-5 items-center">
            ...
            {/* Title */}
            <div className="space-y-6 mb-16 mt-5">
              ...
              <div className="space-y-4">
                <div className="flex flex-col sm:flex-row gap-3">
                  <button className="font2 px-8 py-3 border-2 border-amber-800 text-amber-800 hover:bg-amber-800 hover:text-white transition-colors duration-300 tracking-wider text-sm">
                    BOOK NOW
                  </button>
                  <button className="font2 px-8 py-3 border-2 border-amber-800 bg-amber-800 text-white hover:text-amber-800 hover:bg-transparent transition-colors duration-300 tracking-wider text-sm">
                    ASK OUR EXPERT
                  </button>
                </div>
              </div>
              ...
              <div key={experience.id} className="mb-16">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                  ...
                  >
                    ...
                    <p className="font2 text-gray-700 leading-relaxed">
      ...
      {modal.open && modal.images.length > 0 && (
        <div className="fixed inset-0 bg-black/95 z-50 flex items-center justify-center">
          <div className="relative w-full h-full flex flex-col">
            <button
              onClick={closeModal}
              className="absolute top-6 right-6 z-20 bg-black/50 hover:bg-black/70 text-white rounded-full p-3 transition-colors duration-300"
            >
              <svg
                className="w-6 h-6"
                fill="none"
            ...
            {modal.title && (
              <div className="absolute top-6 left-6 z-20">
                <div className="bg-black/70 px-4 py-2 ">
                  <h3 className="font1 text-white font-semibold text-lg">
                    {modal.title}
                  </h3>
      ...
      <div className="text-center py-16 px-4">
        ...
        <p className="font2 text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
